...
A small native GTK4/libadwaita Linux desktop app for downloading Twitch Clips, YouTube and TikTok videos in the best quality available — mix and match all three kinds of links in the same box.
...
- **Twitch Clips, YouTube and TikTok videos in the same input box** — paste any mix of `twitch.tv`/`clips.twitch.tv` clip links, `youtube.com`/`youtu.be` video, Shorts or Live links, and `tiktok.com`/`vm.tiktok.com`/`vt.tiktok.com` video links; each is recognized automatically and shown with its own brand color.
